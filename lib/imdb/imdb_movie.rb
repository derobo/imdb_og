class ImdbMovie
  attr_accessor :imdb_id, :color, :title, :directors, :writers, :releases, :release_year, :tagline, :company, :plot, :runtime, :rating, :poster_url, :release_date, :certification, :genres, :actors, :awards, :aka, :languages
